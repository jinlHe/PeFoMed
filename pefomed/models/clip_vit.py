...
from pefomed.models.eva_vit import convert_weights_to_fp16
...
def create_clip_vit_L(img_size=224,use_checkpoint=False,precision="fp16"):
    ...
    url = "https://storage.googleapis.com/sfr-vision-language-research/pefomed/models/BLIP2/clip_vit_L.pth"
