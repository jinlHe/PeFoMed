...
from pefomed.common.dist_utils import (
...
from pefomed.datasets.data_utils import concat_datasets, reorg_datasets_by_split
from pefomed.datasets.datasets.dataloader_utils import (
    IterLoader,
    MultiIterLoader,
    PrefetchLoader,
)
...
class RunnerBase:
    ...
    def lr_scheduler(self):
        ...
        if self._lr_sched is None:
            ...
            if iters_per_epoch is None:
                print("自动选择iters_per_epoch")
                print("iters_per_epoch:", len(self.dataloaders['train']))
                try:
    ...
    def dataloaders(self) -> dict:
        ...
        if self._dataloaders is None:
            ...
            # print("batch_sizes2: ", batch_sizes)
    ...
    def train(self):
        ...
        for cur_epoch in range(self.start_epoch, self.max_epoch):
            ...
            if not self.evaluate_only:
                ...
                # See https://github.com/salesforce/pefomed/issues/449
                ...
                for split_name in self.valid_splits:
                    ...
                    if val_log is not None:
                        if is_main_process():
                            ...
                            print("Now the best epoch:", best_epoch)
        ...
        print("Testing on Best epoch: {}".format(test_epoch))
